    ...
    for producto in productos:
        try:
            ...
            precio_tag = producto.find(
                "span", class_="valtech-carrefourar-product-price-0-x-sellingPrice"
            )
            ...
            enlace = (
                "https://www.carrefour.com.ar" + enlace_tag["href"]
                if enlace_tag
                else "Enlace no encontrado"
            )
